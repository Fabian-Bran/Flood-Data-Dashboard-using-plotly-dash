...
flood_data_df["Phone"] = flood_data_df.Phone.str[:3] + "X-XXXXXXXXXX"
flood_data_df["Lat"] = flood_data_df.Lat.astype(str).str[:3] + ".XXX"
flood_data_df["Lng"] = flood_data_df.Lng.astype(str).str[:3] + ".XXX"
flood_data_df["FullName"] = flood_data_df.FullName.str[:3] + "[REDACTED]"
